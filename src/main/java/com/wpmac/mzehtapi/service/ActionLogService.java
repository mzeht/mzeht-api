...
import com.wpmac.mzehtapi.mapper.days.ActionLogMapper;
...
public class ActionLogService {
    ...
    public void add(HttpServletRequest request) {
        ...
        try {
            ...
            actionLogMapper.add(userActionLog);
        }
    ...
    public List<UserActionLog> findAll(int pageNum, int pageSize) {
        ...
        pageNum -= 1;
        return actionLogMapper.findAll(pageNum * pageSize + 1, pageSize);
    }

    public int getAllCount() {
        return actionLogMapper.getAllCount();
    }
}
